...
impl SyntaxNode {
    ...
    pub fn leaf(kind: SyntaxKind, text: impl Into<EcoString>, span: Range<usize>) -> Self {
    ...
    pub fn error(error: SyntaxError, text: impl Into<EcoString>, span: Range<usize>) -> Self {
...
impl LeafNode {
    fn new(kind: SyntaxKind, text: impl Into<EcoString>, span: Range<usize>) -> Self {
